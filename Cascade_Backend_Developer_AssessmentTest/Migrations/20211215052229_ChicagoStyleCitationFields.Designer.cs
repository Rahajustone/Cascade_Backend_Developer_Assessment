...
namespace Cascade_Backend_Developer_AssessmentTest.Migrations
{
    ...
    [Migration("20211215052229_ChicagoStyleCitationFields")]
    partial class ChicagoStyleCitationFields
    {
            ...
            modelBuilder.Entity("Cascade_Backend_Developer_AssessmentTest.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Location = "pp. 120-126",
                            Price = 33.5m,
                            PublicationDate = new DateTime(2021, 12, 14, 23, 22, 29, 477, DateTimeKind.Local).AddTicks(1255),
                            Publisher = "GEEKULAR",
                            Title = "Testable book",
                        ...
                        new
                        {
                            ...
                            Location = "pp. 120-126",
                            Price = 125.5m,
                            PublicationDate = new DateTime(2021, 12, 14, 23, 22, 29, 482, DateTimeKind.Local).AddTicks(1616),
                            Publisher = "VERBUS",
                        ...
                        new
                        {
                            ...
                            Location = "pp. 120-126",
                            Price = 125.5m,
                            PublicationDate = new DateTime(2021, 12, 14, 23, 22, 29, 482, DateTimeKind.Local).AddTicks(1679),
                            Publisher = "VERBUS",
                            Title = "Being goog boy",
                            TitleOfContainer = "On Writing, Editing, and Publishing",
                            TitleOfSource = "Behind the Blue Pencil: Censorship: Cencorship?"
                        ...
                        new
                        {
                            ...
                            Location = "pp. 120-126",
                            Price = 125.3m,
                            PublicationDate = new DateTime(2021, 12, 14, 23, 22, 29, 482, DateTimeKind.Local).AddTicks(1686),
                            Publisher = "Ahmet",
                            Title = "Being goog boy",
                            TitleOfContainer = "On Writing, Editing, and Publishing",
                            TitleOfSource = "Behind the Blue Pencil: Censorship: Cencorship?"
